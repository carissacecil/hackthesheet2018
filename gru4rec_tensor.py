...
class GRU4Rec:
    ...
    def build_model(self):
        ...
        with tf.variable_scope('gru_layer'):
            ...
            print('In build model before failure')
    ...
    def fit(self, data):
        ...
        print('fitting model... epochs ' + str(self.n_epochs))
        for epoch in range(self.n_epochs):
            ...
            maxiter = iters.max()
            sessionIdx = session_idx_arr[iters]
            start = offset_sessions[sessionIdx]
            end = offset_sessions[sessionIdx+1]
            finished = False
            while not finished:
